...
if __name__ =='__main__':
    ...
    out = ['3D', '4D']
    out_selection = input_check('3D (0) or 4D (1) output? (Write 0 or 1): ', [0, 1], 'Not a valid answer, please try agiain   ')
    if out_selection == 0:
    ...
    SFM_selection = input_check('Agisoft-Metashape (0), Mapillary-OpenSFM (1) or MyTriangulation (2)? (Write 0, 1 or 2): ', [0, 1, 2], 'Not a valid answer, please try agiain')
    if SFM_selection == 0:
        message('Agisoft-Metashape option is selected.')
        agi_selection = input_check('Python Module (0) or GUI (1) output? (Write 0 or 1): ', [0, 1], 'Not a valid answer, please try agiain')
    ...
    semantic_selection = input_check('Canny (0) or external semantic information (1)? (Write 0 or 1): ', [0, 1], 'Not a valid answer, please try agiain')
